...
cascade = cv2.CascadeClassifier(r'C:\Users\shine\OneDrive\Desktop\open cv project\haarcascade_frontalface_default (1).xml')
eye_cascade=cv2.CascadeClassifier(r'C:\Users\shine\OneDrive\Desktop\open cv project\haarcascade_eye_tree_eyeglasses.xml')
